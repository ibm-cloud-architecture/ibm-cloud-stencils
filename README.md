...
IBM VPC diagrams are similar to standard VPC diagrams with groupings that organize a VPC solution to visually show taking advantage of the functionality and availability provided by the IBM VPC platform.   The groupings are easily identified in multiple ways with differences in group border color, group fill color, solid vs dashed group border, group tag icon, etc.
