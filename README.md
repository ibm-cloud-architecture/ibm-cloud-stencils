...
5. Changing box border color will also change the tag color allowing customization with other preferred colors, but keep in mind that deviating from standards below might conflict with additional boxes/colors added to the stencils in the future.
