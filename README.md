...
3. Diagram containers if available in a tool (draw.io and Visio) are useful for primary boxes but not secondary boxes.  The draw.io folks would like us to use their containers so we are working through a few issues.  
