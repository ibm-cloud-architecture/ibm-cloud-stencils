...
IBM VPC diagrams are similar to standard VPC diagrams with groupings that organize a VPC solution to visually show the functionality and availability of the IBM VPC platform.   The groupings are easily identified in multiple ways including group border color, group fill color, solid vs dashed group border, group tag icon, etc.
