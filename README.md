...
3. Diagram containers if available in a tool (draw.io and Visio) are intended to be used if not problematic.  draw.io would like us to use their containers so we are working on resolving issues.  
